...
import ru.md.mdhr.AccountApp;
import ru.md.mdhr.config.CacheConfiguration;
import ru.md.mdhr.domain.Authority;
import ru.md.mdhr.domain.User;
import ru.md.mdhr.repository.UserRepository;
import ru.md.mdhr.repository.search.UserSearchRepository;
import ru.md.mdhr.security.AuthoritiesConstants;
import ru.md.mdhr.service.MailService;
import ru.md.mdhr.service.UserService;
import ru.md.mdhr.service.dto.UserDTO;
import ru.md.mdhr.service.mapper.UserMapper;
import ru.md.mdhr.web.rest.errors.ExceptionTranslator;
import ru.md.mdhr.web.rest.vm.ManagedUserVM;
